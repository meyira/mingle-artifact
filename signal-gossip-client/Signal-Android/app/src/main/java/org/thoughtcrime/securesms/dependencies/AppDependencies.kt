...
object AppDependencies {
  ...
  @JvmStatic
  val keyTransparencyStore: Store by lazy {
    provider.provideKeyTransparencyStore()
  }

  @JvmStatic
  val keyTransparencyClient: KeyTransparencyClientGrpc by lazy {
    provider.provideKeyTransparencyClient(keyTransparencyStore)
  }
  ...
  interface Provider {
    ...
    fun provideKeyTransparencyStore(): Store
    fun provideKeyTransparencyClient(store: Store): KeyTransparencyClientGrpc
  }
}
