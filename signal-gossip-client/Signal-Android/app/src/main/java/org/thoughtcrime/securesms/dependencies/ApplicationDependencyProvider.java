...
import org.signal.libsignal.keytrans.StoreImpl;
...
public class ApplicationDependencyProvider implements AppDependencies.Provider {
  ...
  public @NonNull SvrBApi provideSvrBApi(@NotNull Network libSignalNetwork) {
    ...
    @Override
    public @NotNull Store provideKeyTransparencyStore() {
        return new StoreImpl();
    }

    @Override
    public @NotNull KeyTransparencyClientGrpc provideKeyTransparencyClient(@NotNull Store store) {
        return new KeyTransparencyClientGrpc("10.0.2.2", 8080);
    }
